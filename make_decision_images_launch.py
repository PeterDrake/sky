...
def launch_process(job_name, input_dir, input_file_path):
	...
	if BLT:
		if GPU:
			os.system('SGE_Batch -q gpu.q -r "{}" -c "python3 -u make_decision_images.py {} {}" -P 40'.format(name, input_dir, input_file_path))
		else:
			# THIS SHOULD'NT WORK WITH GPU TENSOR FLOW VERSION
			os.system('SGE_Batch -r "{}" -c "python3 -u make_decision_images.py {} {}" -P 40'.format(name, input_dir, input_file_path))
