...
from preprocess_old import BLACK, BLUE, GREEN, YELLOW, WHITE, GRAY
import numpy as np
import unittest
from preprocess_old import simplify_name, extract_timestamp, separate_stamps, remove_white_sun, count_colors
