...
# This must match the name of the Python file containing the code for that model.
...
# tasks in parallel. If BLT is set to True, this is set (later in this file) to 10000 -- our preprocess code runs in
# parallel on BLT.
...
# during training. For a GTX 1080 ti the maximum number of images we can use in a batch is 23.
