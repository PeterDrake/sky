...
This script requires four files: 'shcu_typical_data.csv', 'tiny_data.csv', 'typical_fsc.csv', and 'dubious_fsc.csv'.
...
if __name__ == "__main__":
	...
	# Reads data from tiny_data.csv, takes a sample of the times, and gets data for plotting
	...
	# Reads data from dubious_fsc.csv and uses the times sample from tiny_data.csv to get data for plotting
