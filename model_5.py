...
def build_model():
    ...
    """conv -> maxpool 2 -> conv 2(Same as model_1 but second to last layer has double filters)"""
    ...
    conv2 = Convolution2D(filters=64, kernel_size=3, padding='same', data_format='channels_last', activation='relu')(
        concat2)
