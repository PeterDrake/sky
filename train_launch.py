...
if __name__ == "__main__":
	for i in range(NUM_NETWORKS):
		if BLT:
			os.system('SGE_Batch -q gpu.q -r "{}" -c "CUDA_VISIBLE_DEVICES=' + str(i) + ' python3 -u train.py {} {} {}" -P {}'.format(get_experiment_label(i), get_experiment_label(i), NETWORK_STRUCTURE, JOB_PRIORITY))
		else:
