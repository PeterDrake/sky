...
if __name__ == "__main__":
	...
	for i, batch in enumerate(batches):
		if BLT:
			os.system('SGE_Batch -r "{}" -c "python3 -u center_preprocess.py {} {}" -P 1'.format('typical-pre-batch-{}'.format(i), TYPICAL_DATA_DIR + '/res/' + batch, TYPICAL_DATA_DIR))
		else:
	...
	for i, batch in enumerate(batches):
		if BLT:
			os.system('SGE_Batch -r "{}" -c "python3 -u center_preprocess.py {} {}" -P 1'.format('dubious-pre-batch-{}'.format(i), DUBIOUS_DATA_DIR + '/res/' + batch, DUBIOUS_DATA_DIR))
		else:
